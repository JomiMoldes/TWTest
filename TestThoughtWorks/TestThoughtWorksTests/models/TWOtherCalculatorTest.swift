...
class TWOtherCalculatorTest :XCTestCase {
...
// helpers
    ...
    private func makeSUT(provider:TWLinesAndStationsProvider) -> TWOtherCalculator {
        return TWOtherCalculator(provider:provider)
    }
